...
//Note:
// * Had to convert decimal values to hex due to error: nondigits in number and not hexadecimal in memory
...
#define MEM_PTE_MASK4PAGE (~(MEM_PTE_READONLY | MEM_PTE_DIRTY | MEM_PTE_VALID)) //0b000

#define MEM_L1PTSIZE ((MEM_MAX_VIRTUAL_ADDRESS + 1) >> MEM_L1FIELD_FIRST_BITNUM)  //Page Size is 4KB = 4096
#define MEM_MAX_VIRTUAL_ADDRESS_4PAGE = MEM_MAX_VIRTUAL_ADDRESS >> MEM_L1FIELD_FIRST_BITNUM;
